...
const { alunos, setAlunos } = useState(["Alice", "Fernando", "Ana"]);
    ...
    <Fragment>
      ...
      <form onSubmit={novoAluno}>
        <p>
          ...
          <input type="button" id="btnUrgencia" value="urgência" onClick={novoUrgente}/>
          <input type="button" id="btnAtender" value="Atender" onClick={novoAtender}/>
        </p>
      </form>
